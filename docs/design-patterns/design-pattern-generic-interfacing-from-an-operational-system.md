...
* Provided information needs to include at least the Event timestamp information. This is the moment the data changes were applied in the source / feeding system.
